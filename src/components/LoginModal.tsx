...
const LoginModal = () => {
  const { isLoginModalOpen, closeLoginModal, loginWithGoogle, loginWithFacebook, isLoading } = useAuth();
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <Button
            variant="outline"
            className={cn(
              "w-full h-12 text-base font-medium rounded-xl gap-3",
          ...
          <Button
            ...
            className={cn(
              "w-full h-12 text-base font-medium rounded-xl gap-3",
              "hover:bg-[#1877F2]/5 transition-all"
            )}
          ...
          <div className="bg-muted/30 rounded-xl p-4 space-y-3">
            <p className="text-sm font-medium text-center">Why create an account?</p>
